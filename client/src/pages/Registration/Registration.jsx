...
export default function Registration() {
  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 px-[3vw]">
        <div className="relative flex items-end px-4 pb-10 pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
          <div className="absolute inset-0">
            <img
              src="https://images.pexels.com/photos/7489107/pexels-photo-7489107.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          ...
          <div className="relative">
            <div className="w-full max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
              <h3 className="text-4xl font-bold text-white">
                Now you dont have to worry about finding a roof
              </h3>
          ...
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <div className="mt-3 space-y-3">
              ...
              >
                ...
                Sign up with Google (not avaliable now)
              </button>
            </div>
          </div>
        </div>
